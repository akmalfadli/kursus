...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
   ...
   <footer class="py-12 px-4 border-t border-blue-100 bg-gradient-to-r from-white to-blue-50/20">
        <div class="max-w-4xl mx-auto text-center">
            ...
            <div class="flex flex-wrap justify-center gap-6 text-xs text-slate-500 mb-6">
                <a href="{{ route('privacy-policy') }}" class="hover:text-teal-600 transition-colors">Kebijakan Privasi</a>
                <a href="{{ route('terms-of-service') }}" class="hover:text-teal-600 transition-colors">Syarat & Ketentuan</a>
                <a href="mailto:{{ $content['contact_email'] }}" class="hover:text-teal-600 transition-colors">Kontak</a>
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $content['contact_phone']) }}" target="_blank" class="hover:text-teal-600 transition-colors">WhatsApp</a>
            </div>
            <div class="flex justify-center gap-4 mb-6">
                <a href="mailto:{{ $content['contact_email'] }}" class="text-slate-400 hover:text-teal-600 transition-colors" title="Email">
                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z"></path>
                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z"></path>
                    </svg>
                </a>
                <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $content['contact_phone']) }}" target="_blank" class="text-slate-400 hover:text-teal-600 transition-colors" title="WhatsApp">
